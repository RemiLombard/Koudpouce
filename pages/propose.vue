...
function onFiltersChange(newFilters: ListingFilters) {
  filters.value = { ...newFilters, type: "demande" };
  loadListings();
}
</script>
    ...
    <main class="max-w-5xl mx-auto px-4 py-8">
        ...
        >
          <div>
            ...
            >
              ...
              >
                <Icon name="hand-raised" class="w-6 h-6 text-primary-600" />
              </div>
              Vous proposez un service
            </h1>
            <p class="text-stone-600 text-lg">
              Voici les demandes d'aide en attente
            </p>
      ...
      <template v-else>
        <EmptyState
          ...
          icon="hand-raised"
          title="Aucune demande d'aide trouvée."
