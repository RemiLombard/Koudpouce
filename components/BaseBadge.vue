...
const colorClasses = computed(() => {
  const colors = {
    primary: {
      ...
      soft: "bg-orange-100 text-orange-700 border border-orange-200",
      outline: "border-2 border-orange-300 text-orange-600 bg-transparent",
    },
    secondary: {
      solid:
        "bg-gradient-to-r from-amber-500 to-yellow-500 text-white shadow-sm",
      soft: "bg-amber-100 text-amber-700 border border-amber-200",
      outline: "border-2 border-amber-300 text-amber-600 bg-transparent",
    },
    accent: {
      solid: "bg-gradient-to-r from-red-500 to-orange-500 text-white shadow-sm",
